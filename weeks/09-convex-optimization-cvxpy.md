...
**Builds on:** [Week 7 · Lagrange Multipliers and KKT Conditions](07-lagrange-and-kkt.md) · [Week 8 · Convex Optimization I: Sets, Functions, Problem Hierarchy](08-convex-optimization-theory.md)
**Leads to:** [Week 10 · Stochastic Gradient Methods](10-stochastic-gradient-methods.md) · [Week 14 · Metaheuristics and VLSI Applications](14-metaheuristics-and-vlsi.md)
...
- `constraint.dual_value` ↔ the `λ*` from [Week 7](07-lagrange-and-kkt.md).
...
- [ ] Reproduce your [Week 7](07-lagrange-and-kkt.md) water-filling solution in CVXPY and match the dual variable.
